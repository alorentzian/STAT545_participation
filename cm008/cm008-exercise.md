...
first calculate median for each country then find min
...
```
    ...
    ## # A tibble: 142 x 3
    ## # Groups:   continent [?]
    ##    continent country                  `min(gain)`
    ##    <fct>     <fct>                          <dbl>
    ##  1 Africa    Algeria                        1.31 
    ##  2 Africa    Angola                        -0.036
    ##  3 Africa    Benin                         -0.371
    ##  4 Africa    Botswana                     -10.2  
    ##  5 Africa    Burkina Faso                   0.064
    ##  6 Africa    Burundi                       -3.48 
    ##  7 Africa    Cameroon                      -2.34 
    ##  8 Africa    Central African Republic      -3.33 
    ##  9 Africa    Chad                          -1.05 
    ## 10 Africa    Comoros                        1.74 
    ## # ... with 132 more rows
